...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const inputs = Array.from(document.querySelectorAll('input[type="text"], input[type="email"], input[type="tel"], input[type="file"]'));
    ...
    if (!document.getElementById('vg-academic-settings-style')) {
        const style = document.createElement('style');
        style.id = 'vg-academic-settings-style';
        style.textContent = `
            .vg-reveal {
                opacity: 0;
    ...
    checkboxes.forEach(checkbox => {
        ...
        label.classList.add('vg-check-card', 'vg-focus-ring');
