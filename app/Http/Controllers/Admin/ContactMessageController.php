...
class ContactMessageController extends Controller
{
    ...
    {
        $contactMessage->load(['replies.admin', 'notes.admin']);
    ...
    public function storeNote(Request $request, ContactMessage $contactMessage)
{
    $validated = $request->validate([
    ...
    AuditLogService::log(
        event: 'note_added',
        description: 'Added internal note to contact message #' . $contactMessage->id,
        category: 'contact_messages',
        subject: $contactMessage,
        properties: [
            'contact_message_id' => $contactMessage->id,
